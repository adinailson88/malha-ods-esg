#!/usr/bin/env python3
"""Baixa do hub malha-ia os JSONs usados pelo eixo ODS/ESG."""
...
def baixar_json(url: str, timeout: int, tentativas: int = 5) -> object:
    req = Request(url, headers={"User-Agent": "malha-ods-esg/1.0"})
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Sincroniza snapshots JSON ODS/ESG a partir do hub malha-ia.")
